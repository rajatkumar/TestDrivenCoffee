...
describe 'Task instance', ->
  ...
  it 'should refuse completion if parent is is not complete', ->
    #(-> task2.complete()).should.throw "Dependent task 'wash dishes' is not completed."
    task2.complete().should.equal "Dependent task 'wash dishes' is not completed."

  it 'should  now complete if parent is complete', ->
    task1.complete().should.be.true
